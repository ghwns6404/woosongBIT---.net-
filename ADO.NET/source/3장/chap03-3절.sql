...
-- 질의 3-9 도서이름 왼쪽 두 번째 위치에 ‘구’라는 문자열을 갖는 도서를 모두 검색하시오.
SELECT *
FROM Book
...
-- 질의 3-20 가격이 8,000원 이상인 도서를 구매한 고객에 대하여 고객별 주문 도서의 총 수량을 구하시오. 단, 2권
이상 구매한 고객만 구한다.
...
-- 질의 3-23 고객의 이름과 고객이 주문한 도서의 가격을 검색하시오.
...
-- 질의 3-27 도서를 구매하지 않은 고객을 포함하여 고객의 이름과 고객이 주문한 도서의 가격을 구하시오.
SELECT Customer.name, saleprice
FROM Customer LEFT OUTER JOIN Orders ON Customer.custid =Orders.custid;	

-- 질의 3-28 가장 비싼 도서의 이름은 무엇인가?
SELECT bookname
FROM Book
