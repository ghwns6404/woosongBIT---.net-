...
DROP TABLE Summer;  /* 기존 테이블이 있으면 삭제하고 새로 생성 준비 */ 
...
-- 질의 7-2 계절학기에 새로운 강좌 JAVA를 개설하시오.
/* JAVA 강좌 삽입 */
...
/* 만약 UPDATE 문을 다음과 같이 하나만 수정하면 데이터 불일치 문제가 발생함 */
UPDATE Summer
SET price=15000
WHERE class='FORTRAN' AND sid=100;

/* Summer 테이블 조회, FORTRAN 수강료 1건만 수정되었음 */
SELECT *
FROM Summer;

/* FORTRAN 수강료를 조회하면 2건이 나옴, 데이터 불일치 발생 */
...
-- 질의 7-5 계절학기에 새로운 강좌 JAVA를 개설하시오.
/* JAVA 강좌 삽입, NULL 값을 입력할 필요 없음 */
